...
async function CollectionSection() {
  ...
  return (
    <article className="home-card outfit-uniqueness group/card w-full overflow-hidden rounded-[4px] border border-foreground/10 bg-card shadow-[0_14px_35px_-24px_rgba(20,15,10,0.55)]">
      <Link
        href="/collections"

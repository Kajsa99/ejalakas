  ...
  return (
    <div className="my-10 min-h-screen p-6">
      <div className="mx-auto flex w-full max-w-2xl flex-col">
        ...
        <div className="flex w-full flex-col items-center gap-6 p-6 dark:bg-zinc-900">
          <div className="mx-6 text-center">
            <h2 className="my-4 text-2xl font-bold">
              Köp tavla: {artwork.name}
            </h2>
            <div className="space-y-4 pb-4 text-center">
              ...
              <ol className="list-inside space-y-4 text-left text-sm leading-loose">
                <li>
                  För att köpa en tavla skickar du först en förfrågan via
                  formuläret eller kontaktar mig på mejl eller telefon. Jag
                  kommer att kontakta dig för att avtala pris och leverans.
                </li>
                <li>
                  Efter avtal har du 14 dagar på dig att betala för tavlan.
                  <strong>
                    Om du inte betalar inom 14 dagar kommer tavlan att säljas
                    till nästa köpare.
                  </strong>
                </li>

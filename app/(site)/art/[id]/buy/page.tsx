...
export default async function BuyArtPage({
  ...
  return (
    <div className="my-10 p-6">
      ...
      <div className="flex w-full flex-col items-center gap-6 bg-amber-50 p-6 dark:bg-zinc-900">
          ...
          <div className="space-y-4 pb-4 text-center">
            ...
            <ol className="list-inside space-y-4 text-left text-sm leading-loose">
              <li>
                ...
                formuläret eller kontaktar mig på mejl eller telefon. Jag kommer
                att kontakta dig för att avtala pris och leverans.
              </li>
              <li>
